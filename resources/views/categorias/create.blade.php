        ...
        <form method="POST" action="{{ route('categorias.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea id="descripcion" name="descripcion" rows="4"
                    class="w-full rounded border p-2">{{ old('descripcion') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                    ...
                    <input id="color" name="color" type="text" value="{{ old('color') }}" class="w-full rounded border p-2"
                        maxlength="20" placeholder="#ff9900 / orange">
                ...
                <div>
                    ...
                    <input id="icono" name="icono" type="text" value="{{ old('icono') }}" class="w-full rounded border p-2"
                        maxlength="60" placeholder="ej: lucide-tag">
